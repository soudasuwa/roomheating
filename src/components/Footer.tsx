    ...
    <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <fieldset className="mt-4 w-full">
              ...
              <div className="relative mt-1.5">
                <select
                  ...
                  className="block w-full appearance-none rounded-md border border-transparent bg-gray-700 bg-none py-2 pl-3 pr-10 text-base text-white focus:border-white focus:outline-none focus:ring-white sm:text-sm"
                >
                  <option>EUR</option> <option>ARS</option>
                  <option>CAD</option> <option>CHF</option> <option>EUR</option>
                  <option>GBP</option> <option>JPY</option> <option>USD</option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2">
                  <svg
                    className="h-4 w-4 text-white"
      ...
      <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p className="mt-8 text-base text-gray-400 md:order-1 md:mt-0">
          <span className="block sm:inline">&copy; 2022 OÜ Cryptotech.</span>
          &nbsp;
